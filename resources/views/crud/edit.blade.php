	        ...
	        @endif
    			...
    			<form action="{{ route('update',$editdata->id) }}" method="post" enctype="multipart/form-data">
    				...
    				<div class="form-group">
					    <label>Name</label>
					    <input type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Enter name" value="{{ $editdata->name }}" name="name">
					    @error('name')
					  ...
					  <div class="form-group">
					    ...
					    <input type="email" class="form-control @error('name') is-invalid @enderror" placeholder="Enter email" value="{{ $editdata->email }}" name="email">
					    @error('email')
							    <strong class="text-danger">{{ $message }}</strong>
							@enderror
					  </div>
